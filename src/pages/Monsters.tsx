    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => setPickerOpen(true/>Adicionar</Button>
        </div>
      </div>
      ...
      {monsters.length === 0 && (
        <Card className="card-hover glow-border">
          <CardContent className="p-12 text-center">
            ...
            <Button variant="outline" className="mt-4" onClick={() => templates.length > 0 ? setPickerOpen(true) : opsetPickerOpen(trueiro monstro</Button>
          </CardContent>
        </Card>
      )}
